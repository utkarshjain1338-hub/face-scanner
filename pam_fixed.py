...
# Python 3 compatible config parser (was "ConfigParser" in Python 2)
import configparser
...
def doAuth(pamh):
	...
	# Set up environment for subprocess (needed in SDDM/display manager context)
	env = os.environ.copy()
	env["PYTHONPATH"] = ""

	# Run compare as python3 subprocess
...
def pam_sm_setcred(pamh, flags, argv):
	"""We don't need to set any credentials, so returns true"""
	return pamh.PAM_SUCCESS
